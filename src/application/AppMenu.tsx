...
const Menu: React.FC = () => {
  function Dashboards() {
    return (
      <AppMenu.Item key="dashboards" id="dashboards" name="Dashboards">
        <AppMenu.Item.Icon
          active={<DashboardColorM onClick={() => {}} />}
          inActive={<DashboardGreyM />}
        />
      </AppMenu.Item>
    );
  }
  ...
  function Analytics() {
    return (
      <AppMenu.Item
        ...
        subMenu={
          <AppMenu.SubMenu>
            ...
            <AppMenu.SubMenu.Item>Expressions</AppMenu.SubMenu.Item>
      ...
      >
        <AppMenu.Item.Icon
          active={<AnalyticsColorM />}
          inActive={<AnalyticsGreyM />}
        />
      </AppMenu.Item>
    );
  }
  ...
  function Campaigns() {
    return (
        ...
        subMenu={
          <AppMenu.SubMenu>
            ...
            <AppMenu.SubMenu.Item>
              Landing Page
              <AppMenu.SubMenu.Item.Action>
                {' '}
                <Icon color="blue" component={<Add3M />} />
              </AppMenu.SubMenu.Item.Action>
            </AppMenu.SubMenu.Item>
            <AppMenu.SubMenu.Item>RTB</AppMenu.SubMenu.Item>
      ...
      >
        <AppMenu.Item.Icon
          active={<CampaignsColorM />}
          inActive={<CampaignsGreyM />}
        />
      </AppMenu.Item>
    );
  }
  ...
  function Customers() {
    return (
      ...
      >
        <AppMenu.Item.Icon
          active={<CustomersColorM />}
          inActive={<CustomersGreyM />}
        />
      </AppMenu.Item>
    );
  }
  ...
  function Workers() {
    return (
      <AppMenu.Item key="workers" name="Workers" id="workers">
        <AppMenu.Item.Icon
          active={<AutomationColorM />}
          inActive={<AutomationGreyM />}
        />
      </AppMenu.Item>
    );
  }
  ...
  function Search() {
    return (
      ...
      >
        <AppMenu.Item.Icon
          active={<AiSearchColorM />}
          inActive={<AiSearchGreyM />}
        />
      </AppMenu.Item>
    );
  }
  ...
  function Footer() {
    return (
      ...
      >
        <AppMenu.Item.Icon
          active={<SettingsColorM />}
          inActive={<SettingsGreyM />}
        />
      </AppMenu.Item>
    );
  }
